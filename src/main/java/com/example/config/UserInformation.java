...
public class UserInformation extends VerticalLayout implements View
{
	...
	public UserInformation(SessionBean sessionBean, String formId)
	{
	...
	{
		Panel pnlTable = new Panel("User List :: "+sessionBean.getCompanyName()+
