...
public class BranchInfo extends VerticalLayout implements View
{
	...
	public BranchInfo(SessionBean sessionBean, String formId)
	{
	...
	{
		pnlTable = new Panel("Branch List :: "+sessionBean.getCompanyName()+
